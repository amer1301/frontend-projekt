...
})({"zyBdS":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "8c02c5f64584c466";
"use strict";
...
},{}],"1XdDN":[function(require,module,exports,__globalThis) {
        ...
        if (newsContainer) {
            ...
            if (Array.isArray(data) && data.length > 0) data.forEach((story)=>{
                ...
                storyElement.innerHTML = `
                        ...
                        <p>${story.Preamble || "Ingen beskrivning tillg\xe4nglig."}</p>
                        <img src="${story.ImageLink}" alt="${story.Headline}" style="width: 100%; max-width: 600px;">
                    `;
                newsContainer.appendChild(storyElement);
            });
            else newsContainer.innerHTML += "<p>Inga nyheter hittades just nu.</p>";
        }
    } catch (error) {
        console.error("Fel vid h\xe4mtning av nyheter:", error);
    }
}
...
},{}]},["zyBdS","1XdDN"], "1XdDN", "parcelRequire94c2")

//# sourceMappingURL=krisinformation.4584c466.js.map

...
})({"fEDUx":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "a214b62c02f123ba";
"use strict";
...
},{}],"b7MCy":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _priority1Png = require("./images/priority1.png");
var _priority1PngDefault = parcelHelpers.interopDefault(_priority1Png);
var _priority2Png = require("./images/priority2.png");
var _priority2PngDefault = parcelHelpers.interopDefault(_priority2Png);
var _priority3Png = require("./images/priority3.png");
var _priority3PngDefault = parcelHelpers.interopDefault(_priority3Png);
var _priority4Png = require("./images/priority4.png");
var _priority4PngDefault = parcelHelpers.interopDefault(_priority4Png);
var _priority5Png = require("./images/priority5.png");
var _priority5PngDefault = parcelHelpers.interopDefault(_priority5Png);
var _markerPng = require("./images/marker.png");
var _markerPngDefault = parcelHelpers.interopDefault(_markerPng);
let map; // Skapa en global variabel för kartan
// Skapa olika ikoner baserat på prioritet
const priorityIcons = {
    1: L.icon({
        iconUrl: (0, _priority1PngDefault.default),
        iconSize: [
            32,
            32
        ],
    ...
    2: L.icon({
        iconUrl: (0, _priority2PngDefault.default),
        iconSize: [
            32,
            32
        ],
    ...
    3: L.icon({
        iconUrl: (0, _priority3PngDefault.default),
        iconSize: [
            32,
            32
        ],
    ...
    4: L.icon({
        iconUrl: (0, _priority4PngDefault.default),
        iconSize: [
            32,
            32
        ],
    ...
    5: L.icon({
        iconUrl: (0, _priority5PngDefault.default),
        iconSize: [
            32,
            32
        ],
...
function updateMap(lat, lon) {
    ...
    const userMarker = L.icon({
        iconUrl: (0, _markerPngDefault.default),
        iconSize: [
            32,
            32
        ],
...
},{"./images/priority1.png":"8oNOd","./images/priority2.png":"fv0AC","./images/priority3.png":"hQ2a8","./images/priority4.png":"9wDzb","./images/priority5.png":"c2Sf6","./images/marker.png":"75y1D","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8oNOd":[function(require,module,exports,__globalThis) {
module.exports = require("baa8c5f84d72f2f9").getBundleURL('dUKFX') + "priority1.f39084ed.png" + "?" + Date.now();

},{"baa8c5f84d72f2f9":"lgJ39"}],"lgJ39":[function(require,module,exports,__globalThis) {
"use strict";
var bundleURL = {};
...
},{}],"fv0AC":[function(require,module,exports,__globalThis) {
module.exports = require("187c55cc61cd288").getBundleURL('dUKFX') + "priority2.c729e418.png" + "?" + Date.now();

},{"187c55cc61cd288":"lgJ39"}],"hQ2a8":[function(require,module,exports,__globalThis) {
module.exports = require("229c4a67327fdac3").getBundleURL('dUKFX') + "priority3.65bdc9bc.png" + "?" + Date.now();

},{"229c4a67327fdac3":"lgJ39"}],"9wDzb":[function(require,module,exports,__globalThis) {
module.exports = require("1f17690ca5511e5e").getBundleURL('dUKFX') + "priority4.d5a7555c.png" + "?" + Date.now();

},{"1f17690ca5511e5e":"lgJ39"}],"c2Sf6":[function(require,module,exports,__globalThis) {
module.exports = require("56cdb59642bcf10f").getBundleURL('dUKFX') + "priority5.3caa98f0.png" + "?" + Date.now();

},{"56cdb59642bcf10f":"lgJ39"}],"75y1D":[function(require,module,exports,__globalThis) {
module.exports = require("3ac44678ce89215d").getBundleURL('dUKFX') + "marker.5b75ded9.png" + "?" + Date.now();

},{"3ac44678ce89215d":"lgJ39"}],"gkKU3":[function(require,module,exports,__globalThis) {
...
},{}]},["fEDUx","b7MCy"], "b7MCy", "parcelRequire94c2")

//# sourceMappingURL=index.02f123ba.js.map

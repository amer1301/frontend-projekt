...
function displayHourlyWeather(data) {
    ...
    if (filteredTimes.length > 0 && filteredTemperatures.length > 0) for(let i = 0; i < filteredTimes.length; i++){
    ...
    else hourlyContainer.innerHTML = "<p>Ingen v\xe4derdata tillg\xe4nglig f\xf6r framtida timmar.</p>";
}
